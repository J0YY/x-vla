...
weight-derived analysis now crosses individual attention layers.
...
control and provide a precise weight-derived analysis surface. The released convolutional files
support the joint-attention equation certificate and are named in the historical capability
aggregate records. Separate ViT checkpoints support
the reduced-Gram subspace screen. We do not claim a direct coefficient-edit interface.
