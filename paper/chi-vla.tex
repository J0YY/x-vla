...
state-of-the-art claim. A materialized whole-policy rational export also remains to be
verified. The result establishes the narrower claim that rational tensor construction is
compatible with competitive closed-loop control.
\end{abstract}
...
normalization. Multi-seed replication and a materialized whole-policy rational export remain
open.
...
polynomial or rational class by construction, but a materialized whole-policy rational export
and numerical end-to-end fold check remain open.
...
the resulting atoms are human-coherent is governed by topology, not by convertibility.
...
a materialized whole-policy rational export, multi-seed rational replication, and matched
closed-loop comparison at full scale.
