...
Cache-backed operations join pinned LeRobot task metadata before using official LIBERO task
splits, and the preflight verifies that the two language sets agree exactly.
