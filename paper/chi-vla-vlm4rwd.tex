...
Complete conventional seeds 1 and 2 and partial-conversion controls, then localize the task-specific gap. \\
...
the lost successes on both platforms. On one A30, eager batch-one latency is $38.05$ ms for the
...
Complete seeds 1 and 2, add partial-conversion controls, and retain the predeclared three-point
noninferiority margin. Seed 0 misses that margin on both tested GPU classes.
...
completed seed, a $4.4$ to $5.8$ point capability gap, and a residual compiled-runtime tax.
Second, the
