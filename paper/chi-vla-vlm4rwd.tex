...
On all ten LIBERO-Object tasks, the convolutional $19.2$M-parameter instantiation reaches
$93.7\%\pm0.8\%$ under the published three-seed protocol. Averaging its three fixed checkpoints
reaches $96.2\%$ at three times the inference cost. On the three released convolutional checkpoint
files associated with those historical aggregates, independent reconstruction covers all $4{,}608$ joint-attention head-input cases
...
historical capability aggregates in Section~\ref{sec:capability}. Their vision stacks contain no attention, so we independently
...
certificate and are associated with the historical capability aggregates. Separate ViT checkpoints support the reduced-Gram subspace
