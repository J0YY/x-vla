...
protocol. We derive an exact weight-based decomposition of softmax-free attention. All $36$
...
representation and $0/20$ for a random subspace. An $80$-trial instruction intervention still
exposes a scene-identity shortcut. The evidence establishes competitive specialist capability
and exact layerwise structure, not broad generalization, negligible cost against a matched
conventional twin, or selective coefficient-level repair.
\end{abstract}
