...
and identifies where the signal concentrates across depth. Across three checkpoints, a causally
ranked $96$-dimensional visual subspace succeeds in $50/60$ matched trials, compared with
...
random projector across action groups and checkpoints. The artifact is behaviorally nontrivial,
reaching $93.7\%\pm0.8\%$ on LIBERO-Object, and a three-checkpoint ensemble reaches $96.2\%$.
We therefore establish a capable model artifact with exact layerwise structure and a compact
causal policy bottleneck.
\end{abstract}
...
\begin{enumerate}
  ...
  \item We test the artifact at behavioral scale. Exact subspaces beat fixed random controls,
        and a causally ranked rank-$96$ visual subspace retains $49$ of $52$ full-policy
  ...
  \item We establish that the analyzed artifact is a capable policy, reaching
        $93.7\%\pm0.8\%$ over three LIBERO-Object seeds. A three-checkpoint ensemble reaches
        $96.2\%$ at three times the inference cost.
\end{enumerate}
...
The action-balanced rank screen identifies a $96$-dimensional subspace, one quarter of the
visual bond. Full representations succeed in $17/20$, $15/20$, and $20/20$ trials across
...
checkpoint and random-control comparison has the same selected-over-random direction, with
exact paired $p\leq 2.4\times10^{-4}$. Using $1{,}024$ discovery samples and $1{,}024$ disjoint
evaluation samples per checkpoint, the selected basis has $53.0$--$110.6\times$ lower
translation error, $37.5$--$62.1\times$ lower rotation error, and $33.5$--$103.0\times$ lower
gripper error than the median equal-rank random projector. This repairs sample reuse but does
