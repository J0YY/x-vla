...
and reveals depth-specific negative controls. Across three checkpoints, a causally ranked
$64$-dimensional visual subspace succeeds in $29/60$ matched trials, compared with $47/60$ for
the full representation and $0/60$ for random subspaces. The causal effect replicates, but
near-lossless preservation does not. On disjoint cache samples, the selected basis has at least
$9.9\times$ lower reconstruction error than the median of five random projectors in every action
group and checkpoint. The
artifact is behaviorally nontrivial, reaching $93.7\%\pm0.8\%$ on LIBERO-Object. The first
matched conventional twin differs by only $0.006\%$ in parameters. Complete same-hardware
replications find a $4.4$-point rational deficit on A30 and $5.8$ points on A6000. Compilation
reduces the latency ratio from $3.49$--$5.33\times$ eager to $1.73$--$1.74\times$ compiled. A
fifteen-configuration direct coefficient-edit sweep yields no candidate that passes both
selectivity gates. We therefore establish a capable model
...
\begin{enumerate}
  ...
  \item We test the artifact at behavioral scale. Exact subspaces beat fixed random controls,
        and a causally ranked visual subspace consistently beats random controls across three
        checkpoints while remaining materially below the full policy.
  \item We establish that the analyzed artifact is a capable policy, reaching
        ...
        same-skeleton conventional twin differs by only $0.006\%$ in parameters. Two complete
...
The three-checkpoint replication reaches $47/60$, $29/60$, and $0/60$. Selected versus random
has exact paired sign $p<0.008$ at every checkpoint, but selected remains $30$ points below full.
The earlier near-lossless result does not replicate. Using $1{,}024$ discovery samples and
$1{,}024$ disjoint evaluation samples per checkpoint, the selected basis has $16.2$--$32.3\times$
lower translation error, $9.9$--$15.0\times$ lower rotation error, and $15.4$--$30.9\times$ lower
gripper error than the median of five equal-rank random projectors. This repairs sample reuse but
does not turn the training-cache diagnostic into held-out task generalization. The exact layerwise attention method in
