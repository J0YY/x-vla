...
This result establishes instruction necessity for familiar LIBERO-Object prompts, objects,
scenes, tasks, and checkpoints. It does not show that the policy completes a counterfactual
prompted goal, nor does it establish paraphrase robustness, unseen-object or compositional
grounding, cross-suite generalization, physical transfer, or a benefit unique to tensor
decomposability.
