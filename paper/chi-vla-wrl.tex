...
twin differs by only $0.006\%$ in parameters. An initial mixed-device pass gives $89.8\%$ for
the control and $85.2\%$ for the rational checkpoint, so the capability cost is not yet isolated.
Compilation reduces the same-A30 latency ratio from $5.33\times$ to $1.74\times$.
...
\begin{enumerate}
  ...
  \item We evaluate two fully rational $20.1$M-parameter policies under a protocol aligned with
        ...
        A same-skeleton conventional twin differs by only $0.006\%$ in parameters, while its
