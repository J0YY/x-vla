...
$93.7\%\pm0.8\%$ over three seeds under the published protocol. Exact weight-derived attention
...
preserves none. Yet an $80$-trial instruction intervention exposes a scene-identity shortcut,
and the first direct coefficient edit fails its selectivity gate. The result is a capable and
structurally inspectable specialist, not a zero-shot generalist or a solved editing interface.
\end{abstract}
