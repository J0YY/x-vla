...
aggregates are positive. A one-sided exact paired test gives $p=1.42\times10^{-56}$. The frozen
$20{,}000$-draw task-stratified state-cluster bootstrap interval is $[61.7,71.3]$ points. All eight
prospectively fixed gates pass.
